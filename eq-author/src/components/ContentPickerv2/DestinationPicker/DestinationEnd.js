...
const Icon = styled(({ isActive, ...rest }) => <IconPage {...rest} />)`
  margin-right: 1em;
  .path {
...
const DestinationEnd = ({ onSelected, isSelected, isDisabled, hideHeader }) => {
  ...
  return (
    <>
      ...
      <SubMenuItem {...enabledProps}>
        <StyledMenuItemTitles>
          <Icon isActive={enabledProps["aria-selected"]} />
          <div>
